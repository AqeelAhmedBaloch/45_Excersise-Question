...
let guestArray: string[]= ["Aqeel","Waseem","Murtaza","Omair"];
let notCome:string = "Omair";
let newGuest: string = "Areeb";

guestArray[guestArray.indexOf(notCome)] = newGuest;

guestArray.map((items)=>
console.log(`Hello, ${items} you are invited to dinner.`));

console.log(`${notCome} Cannot make it, for dinner.`);
